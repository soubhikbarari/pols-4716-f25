...
setwd("/Users/soubhikbarari/Research_Group Dropbox/Soubhik Barari/Academic/Teaching/POLS-4716-GU-DataSciPoli-2025/Demos/02.2-data-wrangling")
...
ces_2020 <- readRDS("~/Research_Group Dropbox/Soubhik Barari/Academic/Teaching/POLS-4716-GU-DataSciPoli-2025/Demos/02.2-data-wrangling/ces_2020_sub.rds")

## If you're already in the working directory, don't need full path
ces_2020 <- readRDS("ces_2020_sub.rds")
