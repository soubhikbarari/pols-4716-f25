...
```{r merge-in-truth, eval=exists('mdl.logit')}
...
```{r roc-curve}
# Source the helper function directly from Github
source("https://raw.githubusercontent.com/soubhikbarari/pols-4716-f25/refs/heads/main/helpers/ml_funcs.R", 
       local = FALSE)
